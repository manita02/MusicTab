  ...
  return (
    <>
      ...
      >
        ...
        >
          <Button label={isUpdating ? "Saving..." : "Save Changes"} variantType="secondary" disabled={isUpdating} onClick={handleSave} />
          <Button label="Cancel" variantType="danger" onClick={onClose} />
        </DialogActions>
      </Dialog>
    </>
  );

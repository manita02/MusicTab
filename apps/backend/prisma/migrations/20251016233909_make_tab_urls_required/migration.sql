/*
  ...
  - Made the column `urlImagen` on table `Tab` required. This step will fail if there are existing NULL values in that column.
  - Made the column `urlYoutube` on table `Tab` required. This step will fail if there are existing NULL values in that column.
